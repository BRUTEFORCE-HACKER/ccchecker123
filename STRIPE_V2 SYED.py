import requests
import webbrowser
webbrowser.open('https://t.me/blackhatdrops')
...
for P in file.readlines():
	...
	try:
	    ...
	    'x-requested-with': 'XMLHttpRequest',
			...
			if "Your card has insufficient funds" in response.json()['stripe_error']:
				    msg='Not Funds ✅'
			elif "security code is incorrect" in response.json()['stripe_error']:
				    msg="Ccn Code ✅"
			elif "Your card does not support this type of purchase." in response.json()['stripe_error']:
				    msg='Not Support ✅'
			else:
				    try:
				    	msg=(response.json()['stripe_error'])
				    except:
				    	msg="Unknown Response"
			print(P+'|'+msg)		 
		else:
			print(P+'|Error Card Declind')
	except:
		print('Please Update Checker\nTelegram:https://t.me/+mOm-1jqi-tAyZDk0 ')			
